...
namespace Y9_DEC_TO_BIN_SKELETON
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //int denaryNum = Convert.ToInt32(Console.ReadLine());    //converts user input to an int
            //int answer = denaryNum;    //assigns the variable "answer" as denary num
            ...
            //Extension: Convert binary to denary

            Console.WriteLine("Please input your binary number with no spaces: ");
            ...
            {
                string singleDigit = binaryNumber.Substring(length - i, 1);
                if (i == 0)
                {
                    collumn = i * 2;
                }
            ...
            //static string DenToBin(int n, int numbase)  //static string means thE data type being returned is a string 
